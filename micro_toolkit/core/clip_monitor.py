...
from micro_toolkit.core.clipboard_quick_panel import ClipboardQuickPanel
...
def build_clip_monitor_launch_args() -> list[str]:
    ...
    return [sys.executable, "-m", "micro_toolkit", "clip-monitor"]
...
def run_clip_monitor_service(_args) -> int:
    ...
    app.setApplicationName("Micro Toolkit Clip Monitor")
