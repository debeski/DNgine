...
from dngine import __version__
...
def create_encrypted_snapshot(
    *,
    ...
    with zipfile.ZipFile(archive_bytes, "w", compression=zipfile.ZIP_DEFLATED) as archive:
        ...
        for root_file in ("LICENSE", "README.md", "requirements.txt", "dngine.spec", "build_linux.sh", "build_windows.sh", "build_windows.bat", "build_macos.sh"):
